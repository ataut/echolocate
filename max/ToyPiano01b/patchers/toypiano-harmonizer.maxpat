...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 20.0, 495.5, 48.0, 22.0 ],
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 167.0, 481.0, 27.0, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 150.5, 177.0, 45.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 461.0, 525.0, 90.0, 22.0 ],
					"text" : "title Echolocate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 461.0, 569.0, 67.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 274.0, 525.0, 83.0, 22.0 ],
					"text" : "loadmess 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 635.0, 123.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 236.5, 369.0, 51.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.live_control_fg"
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 238.0, 341.0, 48.0, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 194.0, 172.5, 23.0, 26.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 352.0, 287.0, 197.0, 22.0 ],
					"text" : "transport @name toto @tempo 132"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 402.5, 239.0, 68.0, 22.0 ],
					"text" : "s eco-reset"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 133.0, 365.0, 37.0, 39.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 184.0, 83.0, 37.0, 39.0 ],
					"text" : "go to"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 322.0, 476.5, 150.0, 47.0 ],
									"text" : "fudge on bar 94 (95) to account for 2/4 bar earlier AT"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 50.0, 215.0, 22.0, 22.0 ],
													"text" : "t 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "" ],
													"patching_rect" : [ 108.0, 185.0, 34.0, 22.0 ],
													"text" : "sel 0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 108.0, 215.0, 22.0, 22.0 ],
													"text" : "t 2"
												}
...
, 											{
										...
										"lines" : [ 											{
												"patchline" : 												{
													...
													"midpoints" : [ 117.5, 330.0, 59.5, 330.0 ],
													"source" : [ "obj-138", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 117.5, 72.0, 117.5, 72.0 ],
													"source" : [ "obj-161", 0 ]
												}
...
,
									"patching_rect" : [ 244.0, 569.0, 100.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 488.0, 692.0, 49.0, 20.0 ],
									"text" : "repeats"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 449.0, 687.0, 30.0, 30.0 ]
								}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 502.0, 31.0, 43.0, 20.0 ],
													"text" : "repeat"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 268.0, 31.0, 26.0, 20.0 ],
													"text" : "bar"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 387.0, 31.0, 44.0, 20.0 ],
													"text" : "rewind"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 208.0, 421.0, 81.0, 20.0 ],
													"text" : "score/monitor"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 65.0, 415.0, 73.0, 33.0 ],
													"text" : "go to repeat\n(transport)"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 465.0, 152.0, 60.0, 22.0 ],
													"text" : "zl.change"
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "int" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 173.0, 293.0, 24.0, 24.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 173.0, 245.0, 54.0, 22.0 ],
													"text" : "deferlow"
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 465.0, 187.0, 40.0, 22.0 ],
													"text" : "t 1 i 0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 30.0, 334.0, 57.0, 22.0 ],
													"text" : "pak i 1 0."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 229.0, 26.0, 30.0, 30.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 465.0, 26.0, 30.0, 30.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 173.0, 416.0, 30.0, 30.0 ]
												}
										...
										"lines" : [ 											{
												"patchline" : 												{
													...
													"midpoints" : [ 358.5, 139.0, 515.5, 139.0 ],
													"source" : [ "obj-1", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 474.5, 109.0, 474.5, 109.0 ],
													"source" : [ "obj-112", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 182.5, 319.0, 182.5, 319.0 ],
													"source" : [ "obj-114", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 182.5, 268.0, 182.5, 268.0 ],
													"source" : [ "obj-116", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 182.5, 358.0, 182.5, 358.0 ],
													"source" : [ "obj-117", 0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-114", 0 ],
													"midpoints" : [ 495.5, 280.0, 182.5, 280.0 ],
													"source" : [ "obj-118", 2 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 474.5, 232.0, 182.5, 232.0 ],
													"source" : [ "obj-118", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 485.0, 280.0, 39.5, 280.0 ],
													"source" : [ "obj-118", 1 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 238.5, 232.0, 238.5, 232.0, 238.5, 319.0, 215.5, 319.0 ],
													"source" : [ "obj-122", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 39.5, 361.0, 39.5, 361.0 ],
													"source" : [ "obj-38", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 474.5, 175.0, 474.5, 175.0 ],
													"source" : [ "obj-46", 0 ]
												}
...
,
									"patching_rect" : [ 127.0, 528.0, 136.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 244.0, 416.0, 60.0, 22.0 ],
									"text" : "zl.change"
								}
...
,
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 244.0, 482.0, 70.0, 22.0 ],
									"saved_object_attributes" : 									{
										"embed" : 1,
										"precision" : 6
									}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 127.0, 253.0, 29.5, 22.0 ],
													"text" : "i"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "" ],
													"patching_rect" : [ 25.0, 187.0, 34.0, 22.0 ],
													"text" : "sel 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "int", "int" ],
													"patching_rect" : [ 25.0, 153.0, 48.0, 22.0 ],
													"text" : "t i i"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "", "int", "int" ],
													"patching_rect" : [ 25.0, 119.0, 48.0, 22.0 ],
													"text" : "change"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 127.0, 25.0, 30.0, 30.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 54.0, 319.0, 30.0, 30.0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 34.5, 177.0, 34.5, 177.0 ],
													"source" : [ "obj-78", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 34.5, 240.0, 136.5, 240.0 ],
													"source" : [ "obj-79", 0 ]
												}
...
,
									"patching_rect" : [ 36.0, 198.0, 110.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 225.0, 65.0, 62.0, 22.0 ],
									"text" : "t b 0 0 0 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 225.0, 33.0, 66.0, 22.0 ],
									"text" : "r eco-reset"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 225.0, 123.0, 29.5, 22.0 ],
									"text" : "-1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 164.0, 692.0, 56.0, 20.0 ],
									"text" : "transport"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 127.0, 687.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 127.0, 123.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 127.0, 168.0, 60.0, 22.0 ],
									"text" : "zl.change"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 71.0, 692.0, 38.0, 20.0 ],
									"text" : "score"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 281.0, 692.0, 26.0, 20.0 ],
									"text" : "bar"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 402.0, 692.0, 32.0, 20.0 ],
									"text" : "beat"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 363.0, 687.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 244.0, 644.0, 41.0, 22.0 ],
									"text" : "set $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 36.25, 328.0, 29.5, 22.0 ],
									"text" : "- 2"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 36.0, 258.0, 110.0, 50.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 412.0, 33.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 36.0, 687.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 244.0, 687.0, 30.0, 30.0 ]
								}
						...
						"lines" : [ 							{
								"patchline" : 								{
									"destination" : [ "obj-4", 0 ],
									"midpoints" : [ 372.5, 66.0, 372.5, 66.0 ],
									"source" : [ "obj-1", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 253.5, 441.0, 253.5, 441.0 ],
									"source" : [ "obj-111", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 294.5, 468.0, 334.5, 468.0 ],
									"source" : [ "obj-111", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 253.5, 507.0, 231.0, 507.0, 231.0, 402.0, 294.5, 402.0 ],
									"order" : 0,
									"source" : [ "obj-113", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 253.5, 507.0, 253.5, 507.0 ],
									"order" : 1,
									"source" : [ "obj-113", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 147.0, 402.0, 253.5, 402.0 ],
									"source" : [ "obj-119", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 136.5, 351.0, 136.5, 351.0 ],
									"source" : [ "obj-119", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 253.5, 552.0, 253.5, 552.0 ],
									"source" : [ "obj-126", 2 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-3", 0 ],
									"midpoints" : [ 195.0, 630.0, 253.5, 630.0 ],
									"order" : 0,
									"source" : [ "obj-126", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 136.5, 552.0, 136.5, 552.0 ],
									"source" : [ "obj-126", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 195.0, 672.0, 45.5, 672.0 ],
									"order" : 1,
									"source" : [ "obj-126", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 253.5, 630.0, 458.5, 630.0 ],
									"source" : [ "obj-163", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 253.5, 669.0, 253.5, 669.0 ],
									"source" : [ "obj-3", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-111", 1 ],
									"midpoints" : [ 234.5, 402.0, 294.5, 402.0 ],
									"order" : 0,
									"source" : [ "obj-42", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 234.5, 402.0, 195.0, 402.0 ],
									"order" : 1,
									"source" : [ "obj-42", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 234.5, 162.0, 177.5, 162.0 ],
									"order" : 2,
									"source" : [ "obj-42", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 136.5, 309.0, 136.5, 309.0 ],
									"source" : [ "obj-44", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 45.5, 309.0, 45.75, 309.0 ],
									"source" : [ "obj-44", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-3", 0 ],
									"midpoints" : [ 45.75, 630.0, 253.5, 630.0 ],
									"source" : [ "obj-51", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 421.5, 108.0, 45.5, 108.0 ],
									"source" : [ "obj-57", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 234.5, 57.0, 234.5, 57.0 ],
									"source" : [ "obj-59", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-135", 0 ],
									"midpoints" : [ 277.5, 402.0, 458.5, 402.0 ],
									"source" : [ "obj-66", 4 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-23", 0 ],
									"midpoints" : [ 245.25, 108.0, 136.5, 108.0 ],
									"source" : [ "obj-66", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-4", 0 ],
									"midpoints" : [ 256.0, 108.0, 372.5, 108.0 ],
									"source" : [ "obj-66", 2 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 234.5, 90.0, 234.5, 90.0 ],
									"source" : [ "obj-66", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-96", 0 ],
									"midpoints" : [ 266.75, 108.0, 45.5, 108.0 ],
									"source" : [ "obj-66", 3 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 136.5, 222.0, 136.5, 222.0 ],
									"source" : [ "obj-96", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 45.5, 222.0, 45.5, 222.0 ],
									"source" : [ "obj-96", 0 ]
								}
...
,
					"patching_rect" : [ 64.0, 287.0, 193.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 220.0, 183.0, 65.0, 22.0 ],
					"text" : "pak -2 1 0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 385.0, 465.0, 32.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 392.0, 176.0, 32.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.live_control_fg"
						}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 343.0, 465.0, 33.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 351.0, 176.0, 33.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.live_control_fg"
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 777.0, 570.0, 20.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 684.0, 329.0, 20.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 445.25, 70.0, 55.0, 35.0 ],
					"text" : ";\rdsp start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 445.25, 25.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 627.0, 226.0, 320.0, 40.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 629.0, 184.0, 344.0, 40.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 520.0, 25.0, 59.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 527.0, 562.0, 65.0, 20.0 ],
					"text" : "DSP",
					"texton" : "reset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 520.0, 70.0, 59.0, 35.0 ],
					"text" : ";\rdsp open"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 710.0, 22.0, 158.0, 22.0 ],
					"saved_object_attributes" : 					{
						"allwindowsactive" : 1,
						"appicon_mac" : "",
						"appicon_win" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 324.25, 70.0, 29.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 361.25, 70.0, 74.0, 35.0 ],
					"text" : ";\rdacs 0. 100."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 324.25, 25.0, 45.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 528.0, 526.0, 64.0, 31.0 ],
					"text" : "PANIC",
					"texton" : "PANIC"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 141.0, 400.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 161.0, 86.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "5",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 65.0, 525.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 447.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "4",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 160.0, 583.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 546.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "3",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 34.0, 124.0, 20.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 372.0, 583.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 500.0, 562.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 398.0, 570.0, 45.0, 45.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 527.0, 587.0, 65.0, 65.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 979.0, 46.0, 371.0, 355.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 85.0, 469.0, 62.0, 22.0 ],
					"text" : "pak 1 1 0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 869.0, 138.0, 40.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 818.0, 114.0, 91.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 710.0, 90.0, 249.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 710.0, 114.0, 199.0, 5.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 74.0, 458.0, 5.0 ],
					"saved_attribute_attributes" : 					{
						"linecolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 710.0, 46.0, 182.0, 46.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 12.0, 13.0, 182.0, 46.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.live_control_fg"
						}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 88.0, 123.5, 60.0, 21.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 117.0, 525.0, 32.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 43.0, 416.0, 32.0, 20.0 ],
					"text" : "click"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 36.0, 160.0, 41.0, 22.0 ],
									"text" : "line 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 36.0, 129.0, 57.0, 22.0 ],
									"text" : "pack f 80"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 36.0, 100.0, 171.0, 22.0 ],
									"text" : "scale 0 157 0. 2. 2. @classic 0"
								}
...
,
					"patching_rect" : [ 190.0, 615.0, 42.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					"id" : "obj-341",
					"knobcolor" : [ 0.145098039215686, 1.0, 0.0, 1.0 ],
					"maxclass" : "slider",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 190.0, 576.0, 167.0, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 42.0, 482.0, 34.0, 155.0 ],
					"size" : 158.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 89.0, 664.0, 34.0, 22.0 ],
					"text" : "*~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 88.0, 724.0, 45.0, 22.0 ],
					"text" : "dac~ 3"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 89.0, 523.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 42.0, 440.0, 34.0, 34.0 ],
					"varname" : "toggle"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 96.0, 17.0, 66.0, 22.0 ],
									"text" : "r eco-reset"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 89.5, 123.5, 306.0, 33.0 ],
									"text" : "note: click track depends on transport status:\nit can be turned off but sounds only when transport is on"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 55.0, 60.5, 60.0, 22.0 ],
									"text" : "zl.change"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 42.0, 402.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 27.0, 129.0, 34.0, 22.0 ],
									"text" : "sel 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 161.0, 328.0, 33.0, 22.0 ],
									"text" : "* 20."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 255.0, 237.0, 70.0, 22.0 ],
									"text" : "loadmess 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 27.0, 96.0, 47.0, 22.0 ],
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 100.0, 207.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 42.0, 180.0, 22.0, 22.0 ],
									"text" : "t b"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 219.0, 299.0, 47.0, 20.0 ],
									"text" : "volume"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 218.0, 238.0, 26.0, 20.0 ],
									"text" : "tick"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 136.0, 238.0, 37.0, 20.0 ],
									"text" : "down"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 161.0, 298.0, 50.0, 22.0 ],
									"varname" : "flonum"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 42.0, 357.0, 138.0, 22.0 ],
									"text" : "*~ 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 179.0, 237.0, 35.0, 22.0 ],
									"text" : "1000"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 100.0, 237.0, 35.0, 22.0 ],
									"text" : "2000"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 100.0, 180.0, 98.0, 22.0 ],
									"text" : "sel 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 42.0, 298.0, 106.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 42.0, 237.0, 42.0, 22.0 ],
									"text" : "click~"
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 170.5, 322.0, 170.5, 322.0 ],
									"source" : [ "obj-121", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-113", 0 ],
									"midpoints" : [ 51.5, 322.0, 51.5, 322.0 ],
									"source" : [ "obj-13", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 264.5, 283.0, 170.5, 283.0 ],
									"source" : [ "obj-144", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 170.5, 352.0, 170.5, 352.0 ],
									"source" : [ "obj-146", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-17", 0 ],
									"midpoints" : [ 51.5, 166.0, 109.5, 166.0 ],
									"order" : 0,
									"source" : [ "obj-147", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 0 ],
									"midpoints" : [ 51.5, 154.0, 51.5, 154.0 ],
									"order" : 1,
									"source" : [ "obj-147", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 188.5, 205.0, 188.5, 205.0 ],
									"source" : [ "obj-17", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 109.5, 262.0, 109.5, 262.0 ],
									"source" : [ "obj-18", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-13", 2 ],
									"midpoints" : [ 188.5, 283.0, 109.5, 283.0 ],
									"source" : [ "obj-19", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 109.5, 232.0, 109.5, 232.0 ],
									"source" : [ "obj-29", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 188.5, 232.0, 188.5, 232.0 ],
									"source" : [ "obj-31", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-8", 0 ],
									"midpoints" : [ 51.5, 205.0, 51.5, 205.0 ],
									"source" : [ "obj-5", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-13", 0 ],
									"midpoints" : [ 51.5, 262.0, 51.5, 262.0 ],
									"source" : [ "obj-8", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 36.5, 121.0, 36.5, 121.0 ],
									"source" : [ "obj-96", 0 ]
								}
...
,
					"patching_rect" : [ 89.0, 615.0, 42.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 324.0, 183.0, 30.0, 22.0 ],
					"text" : "0."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 556.0, 123.0, 68.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 166.0, 123.0, 204.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 239.0, 466.0, 46.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 263.0, 172.5, 46.0, 27.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.live_control_fg"
						}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 152.0, 466.0, 37.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 114.0, 172.5, 37.0, 27.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.live_control_fg"
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 197.0, 400.0, 88.0, 62.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 221.0, 108.0, 88.0, 62.0 ],
					"textcolor" : [ 0.145098039215686, 1.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 85.0, 400.0, 97.0, 62.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 114.0, 108.0, 104.0, 62.0 ],
					"textcolor" : [ 0.145098039215686, 1.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 324.0, 425.0, 207.0, 35.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 324.0, 390.0, 126.0, 22.0 ],
					"text" : "set \" \" $1 : $2 : $3 . $4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 324.0, 343.0, 225.0, 22.0 ],
					"text" : "translate ticks hh:mm:ss @mode interval"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 9,
					"outlettype" : [ "int", "int", "float", "float", "float", "", "int", "float", "" ],
					"patching_rect" : [ 64.0, 239.0, 186.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "int", "int" ],
									"patching_rect" : [ 55.0, 324.5, 48.0, 22.0 ],
									"text" : "change"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 200.0, 448.0, 32.0, 22.0 ],
									"text" : "t b b"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 25.0, 662.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 58.0, 724.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "int", "int" ],
									"patching_rect" : [ 36.0, 105.0, 48.0, 22.0 ],
									"text" : "change"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 36.0, 241.0, 38.0, 22.0 ],
									"text" : "sel -1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 98.0, 729.0, 69.0, 20.0 ],
									"text" : "to transport"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 534.0, 241.0, 67.0, 22.0 ],
									"text" : "timesig 2 4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 457.0, 241.0, 67.0, 22.0 ],
									"text" : "timesig 4 4"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 457.0, 175.0, 67.0, 22.0 ],
									"text" : "sel 1 85 86"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 25.0, 614.0, 29.5, 22.0 ],
									"text" : "0"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 260.0, 24.0, 63.0, 33.0 ],
									"text" : "––1 (start)\n204 (end)"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 333.0, 24.0, 93.0, 47.0 ],
									"text" : "change timesig:\n85 = 128 = 2/4\n86 = 129 = 4/4"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 436.0, 24.0, 117.0, 114.0 ],
									"text" : "number = bar = beat\n1 = 1 = 1 (start)\n2 = 9 = 17\n3 = 33 = 61\n4 = 49 = 85\n5 = 53 = 93\n6 = 77 = 120\n7 = 146 = 205 (end)"
								}
...
,
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 36.0, 175.0, 55.0, 22.0 ],
									"saved_object_attributes" : 									{
										"embed" : 1,
										"precision" : 6
									}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 215.0, 445.0, 165.0, 33.0 ],
													"text" : "note: for feedback to be zero,\nfb parameter needs to be 64."
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 330.0, 267.0, 24.0, 24.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 330.0, 303.0, 109.0, 35.0 ],
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 330.0, 162.0, 24.0, 24.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 330.0, 198.0, 116.0, 35.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 330.0, 396.0, 96.0, 35.0 ],
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 215.0, 267.0, 24.0, 24.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 215.0, 303.0, 96.0, 76.0 ],
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 219.0, 163.0, 24.0, 24.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 219.0, 199.0, 103.0, 49.0 ],
...
,
													"patching_rect" : [ 172.0, 79.5, 108.0, 22.0 ],
													"saved_object_attributes" : 													{
														"description" : "",
														"digest" : "",
														"globalpatchername" : "",
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 172.0, 16.5, 24.0, 24.0 ]
												}
...
,
													"patching_rect" : [ 172.0, 49.5, 123.0, 22.0 ],
													"saved_object_attributes" : 													{
														"description" : "",
														"digest" : "",
														"globalpatchername" : "",
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "int" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 89.0, 207.0, 24.0, 24.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 57.0, 207.0, 24.0, 24.0 ]
												}
...
,
													"patching_rect" : [ 57.0, 242.0, 51.0, 22.0 ],
													"saved_object_attributes" : 													{
														"description" : "",
														"digest" : "",
														"globalpatchername" : "",
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 488.0, 179.0, 87.0, 69.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 488.0, 102.0, 87.0, 69.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 488.0, 26.0, 87.0, 69.0 ],
...
,
													"patching_rect" : [ 57.0, 171.0, 92.0, 22.0 ],
													"saved_object_attributes" : 													{
														"description" : "",
														"digest" : "",
														"globalpatchername" : "",
...
,
													"patching_rect" : [ 69.0, 34.0, 64.0, 22.0 ],
													"saved_object_attributes" : 													{
														"description" : "",
														"digest" : "",
														"globalpatchername" : "",
...
,
													"patching_rect" : [ 69.0, 78.0, 80.0, 22.0 ],
													"saved_object_attributes" : 													{
														"description" : "",
														"digest" : "",
														"globalpatchername" : "",
...
,
									"patching_rect" : [ 357.0, 241.0, 44.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 309.0, 395.0, 24.0, 24.0 ]
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 189.0, 410.0, 114.0, 69.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 189.0, 325.0, 114.0, 69.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 189.0, 239.0, 114.0, 69.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 189.0, 152.0, 114.0, 69.0 ],
...
,
									"patching_rect" : [ 365.0, 457.0, 78.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 58.0, 614.0, 29.5, 22.0 ],
									"text" : "1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 25.0, 724.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 273.0, 395.0, 24.0, 24.0 ]
								}
...
,
									"patching_rect" : [ 332.0, 539.0, 107.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 237.0, 395.0, 24.0, 24.0 ]
								}
...
,
									"patching_rect" : [ 305.0, 569.0, 45.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 264.25, 479.0, 29.5, 22.0 ],
									"text" : "0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 227.25, 479.0, 29.5, 22.0 ],
									"text" : "1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 249.0, 510.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 200.0, 395.0, 24.0, 24.0 ]
								}
...
,
									"patching_rect" : [ 213.0, 539.0, 55.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "bang" ],
													"patching_rect" : [ 72.0, 92.5, 32.0, 22.0 ],
													"text" : "t b b"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 105.0, 449.5, 84.0, 69.0 ],
													"text" : ";\rharm4 fb 64. 10;\rharm4 trsp 0. 10;\rharm4 win 60. 10;\rharm4 del 200. 10;\rharm4 amp 64. 10"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 105.0, 372.5, 84.0, 69.0 ],
													"text" : ";\rharm3 fb 64. 10;\rharm3 trsp 0. 10;\rharm3 win 60. 10;\rharm3 del 200. 10;\rharm3 amp 64. 10"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 105.0, 293.5, 84.0, 69.0 ],
													"text" : ";\rharm2 fb 64. 10;\rharm2 trsp 0. 10;\rharm2 win 60. 10;\rharm2 del 200. 10;\rharm2 amp 64. 10"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 105.0, 210.5, 87.0, 69.0 ],
													"text" : ";\rharm1 fb 64. 10;\rharm1 trsp 0. 10;\rharm1 win 60. 10;\rharm1 del 200. 10;\rharm1 amp 126. 10"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 335.0, 166.0, 150.0, 20.0 ],
													"text" : "turn up harm4?"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 18.0, 141.0, 94.0, 49.0 ],
...
,
									"patching_rect" : [ 164.0, 569.0, 44.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 128.0, 395.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 55.0, 362.0, 346.0, 22.0 ],
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "bang", "bang", "bang" ],
													"patching_rect" : [ 215.099997999999999, 82.0, 42.0, 22.0 ],
													"text" : "t b b b"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "bang" ],
													"patching_rect" : [ 337.599998000000028, 108.0, 67.0, 22.0 ],
													"text" : "delay 5000"
												}
...
,
									"patching_rect" : [ 91.0, 614.0, 92.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 58.0, 420.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"text" : "2",
									"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 44.000001327449802, 102.0, 78.0, 29.0 ],
													"text" : ";\renable-harms 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 44.000001327449802, 137.0, 96.0, 29.0 ],
													"text" : ";\rharms-to-dacs 127 10"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 44.000001327449802, 172.0, 71.0, 35.0 ],
													"text" : ";\rdacs 127 0."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 44.000001327449802, 218.0, 122.0, 76.0 ],
...
, 											{
										...
										"lines" : [ 											{
												"patchline" : 												{
													"destination" : [ "obj-39", 0 ],
													"midpoints" : [ 53.500001327449802, 72.0, 53.500001327449802, 72.0 ],
													"order" : 3,
													"source" : [ "obj-25", 0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-41", 0 ],
													"midpoints" : [ 53.500001327449802, 87.0, 30.0, 87.0, 30.0, 132.0, 53.500001327449802, 132.0 ],
													"order" : 2,
													"source" : [ "obj-25", 0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-42", 0 ],
													"midpoints" : [ 53.500001327449802, 87.0, 30.0, 87.0, 30.0, 168.0, 53.500001327449802, 168.0 ],
													"order" : 1,
													"source" : [ "obj-25", 0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-92", 0 ],
													"midpoints" : [ 53.500001327449802, 87.0, 30.0, 87.0, 30.0, 213.0, 53.500001327449802, 213.0 ],
													"order" : 0,
													"source" : [ "obj-25", 0 ]
												}
...
,
									"patching_rect" : [ 58.0, 492.0, 34.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 91.0, 395.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 58.0, 442.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"text" : "1",
									"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 55.0, 287.0, 35.388349235057831, 22.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 173.5, 442.0, 273.75, 442.0 ],
									"order" : 0,
									"source" : [ "obj-10", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-7", 0 ],
									"midpoints" : [ 173.5, 421.0, 173.5, 421.0 ],
									"order" : 1,
									"source" : [ "obj-10", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-15", 0 ],
									"midpoints" : [ 100.5, 442.0, 273.75, 442.0 ],
									"order" : 0,
									"source" : [ "obj-128", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-16", 0 ],
									"midpoints" : [ 100.5, 601.0, 67.5, 601.0 ],
									"order" : 3,
									"source" : [ "obj-128", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-4", 0 ],
									"midpoints" : [ 100.5, 478.0, 67.5, 478.0 ],
									"order" : 2,
									"source" : [ "obj-128", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-6", 0 ],
									"midpoints" : [ 100.5, 421.0, 100.5, 421.0 ],
									"order" : 1,
									"source" : [ "obj-128", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 258.5, 532.0, 258.5, 532.0 ],
									"source" : [ "obj-135", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-138", 0 ],
									"midpoints" : [ 246.5, 437.0, 314.5, 437.0 ],
									"order" : 0,
									"source" : [ "obj-140", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-15", 0 ],
									"midpoints" : [ 246.5, 442.0, 273.75, 442.0 ],
									"order" : 1,
									"source" : [ "obj-140", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 282.5, 431.0, 341.5, 431.0 ],
									"order" : 0,
									"source" : [ "obj-147", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-15", 0 ],
									"midpoints" : [ 282.5, 421.0, 273.75, 421.0 ],
									"order" : 1,
									"source" : [ "obj-147", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-31", 0 ],
									"midpoints" : [ 67.5, 649.0, 34.5, 649.0 ],
									"source" : [ "obj-16", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-23", 0 ],
									"midpoints" : [ 318.5, 426.0, 374.5, 426.0 ],
									"source" : [ "obj-22", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-2", 0 ],
									"midpoints" : [ 45.5, 130.0, 45.5, 130.0 ],
									"order" : 1,
									"source" : [ "obj-3", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 45.5, 160.0, 466.5, 160.0 ],
									"order" : 0,
									"source" : [ "obj-3", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-11", 0 ],
									"midpoints" : [ 34.5, 688.0, 34.5, 688.0 ],
									"source" : [ "obj-31", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-31", 0 ],
									"midpoints" : [ 34.5, 637.0, 34.5, 637.0 ],
									"source" : [ "obj-70", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-78", 0 ],
									"midpoints" : [ 498.5, 226.0, 466.5, 226.0 ],
									"source" : [ "obj-75", 2 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-78", 0 ],
									"midpoints" : [ 466.5, 199.0, 466.5, 199.0 ],
									"source" : [ "obj-75", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-79", 0 ],
									"midpoints" : [ 482.5, 226.0, 543.5, 226.0 ],
									"source" : [ "obj-75", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-29", 0 ],
									"midpoints" : [ 466.5, 709.0, 67.5, 709.0 ],
									"source" : [ "obj-78", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-29", 0 ],
									"midpoints" : [ 543.5, 709.0, 67.5, 709.0 ],
									"source" : [ "obj-79", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-10", 0 ],
									"midpoints" : [ 173.5, 385.0, 173.5, 385.0 ],
									"source" : [ "obj-8", 3 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-128", 0 ],
									"midpoints" : [ 100.833333333333343, 385.0, 100.5, 385.0 ],
									"source" : [ "obj-8", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 209.833333333333343, 385.0, 209.5, 385.0 ],
									"source" : [ "obj-8", 4 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 246.166666666666657, 385.0, 246.5, 385.0 ],
									"source" : [ "obj-8", 5 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-22", 0 ],
									"midpoints" : [ 318.833333333333371, 385.0, 318.5, 385.0 ],
									"source" : [ "obj-8", 7 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-9", 0 ],
									"midpoints" : [ 137.166666666666686, 385.0, 137.5, 385.0 ],
									"source" : [ "obj-8", 2 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 64.5, 265.0, 64.5, 265.0 ],
									"source" : [ "obj-86", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-70", 0 ],
									"midpoints" : [ 45.5, 319.0, 34.5, 319.0 ],
									"source" : [ "obj-86", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-15", 0 ],
									"midpoints" : [ 137.5, 442.0, 273.75, 442.0 ],
									"order" : 0,
									"source" : [ "obj-9", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-6", 1 ],
									"midpoints" : [ 137.5, 601.0, 173.5, 601.0 ],
									"order" : 1,
									"source" : [ "obj-9", 0 ]
								}
...
,
					"patching_rect" : [ 64.0, 70.0, 51.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 600.5, 308.0, 373.0, 443.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 100.0, 217.0, 375.0, 451.0 ],
					"viewvisibility" : 1
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 98.5, 639.0, 98.5, 639.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 283.5, 561.0, 199.5, 561.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 565.5, 168.0, 333.5, 168.0 ],
					"order" : 0,
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 0 ],
					"midpoints" : [ 565.5, 168.0, 229.5, 168.0 ],
					"order" : 1,
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-119", 0 ],
					"midpoints" : [ 333.5, 414.0, 333.5, 414.0 ],
					"source" : [ "obj-120", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-120", 0 ],
					"midpoints" : [ 333.5, 366.0, 333.5, 366.0 ],
					"source" : [ "obj-122", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 98.5, 549.0, 98.5, 549.0 ],
					"source" : [ "obj-125", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 1 ],
					"midpoints" : [ 199.5, 651.0, 113.5, 651.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 1 ],
					"midpoints" : [ 206.5, 561.0, 121.5, 561.0 ],
					"source" : [ "obj-149", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-34", 0 ],
					"midpoints" : [ 94.5, 465.0, 94.5, 465.0 ],
					"source" : [ "obj-150", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 175.5, 225.0, 73.5, 225.0 ],
					"order" : 1,
					"source" : [ "obj-153", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 175.5, 225.0, 361.5, 225.0 ],
					"order" : 0,
					"source" : [ "obj-153", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"midpoints" : [ 73.5, 165.25, 29.5, 165.25 ],
					"order" : 2,
					"source" : [ "obj-185", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-56", 0 ],
					"midpoints" : [ 73.5, 147.0, 73.5, 147.0 ],
					"order" : 1,
					"source" : [ "obj-185", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-71", 0 ],
					"midpoints" : [ 73.5, 225.0, 361.5, 225.0 ],
					"order" : 0,
					"source" : [ "obj-185", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-25", 0 ],
					"midpoints" : [ 644.5, 168.0, 333.5, 168.0 ],
					"order" : 0,
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 0 ],
					"midpoints" : [ 644.5, 168.0, 229.5, 168.0 ],
					"order" : 1,
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-56", 0 ],
					"midpoints" : [ 105.5, 108.0, 60.0, 108.0, 60.0, 225.0, 73.5, 225.0 ],
					"source" : [ "obj-20", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-122", 0 ],
					"midpoints" : [ 333.5, 207.0, 333.5, 207.0 ],
					"order" : 1,
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-70", 0 ],
					"midpoints" : [ 333.5, 225.0, 412.0, 225.0 ],
					"order" : 0,
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-56", 0 ],
					"midpoints" : [ 229.5, 225.0, 73.5, 225.0 ],
					"order" : 1,
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-71", 0 ],
					"midpoints" : [ 229.5, 225.0, 361.5, 225.0 ],
					"order" : 0,
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-56", 0 ],
					"midpoints" : [ 94.5, 492.0, 51.0, 492.0, 51.0, 234.0, 73.5, 234.0 ],
					"source" : [ "obj-34", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"midpoints" : [ 199.5, 612.0, 199.5, 612.0 ],
					"source" : [ "obj-341", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 219.625, 273.0, 247.5, 273.0 ],
					"source" : [ "obj-56", 7 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 94.375, 264.0, 160.5, 264.0 ],
					"source" : [ "obj-56", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-42", 0 ],
					"midpoints" : [ 333.75, 57.0, 370.75, 57.0 ],
					"order" : 0,
					"source" : [ "obj-59", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 333.75, 48.0, 333.75, 48.0 ],
					"order" : 1,
					"source" : [ "obj-59", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-24", 0 ],
					"midpoints" : [ 98.5, 687.0, 97.5, 687.0 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-185", 0 ],
					"midpoints" : [ 333.75, 108.0, 73.5, 108.0 ],
					"source" : [ "obj-61", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-149", 0 ],
					"midpoints" : [ 204.0, 351.0, 206.5, 351.0 ],
					"source" : [ "obj-64", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 160.5, 312.0, 94.5, 312.0 ],
					"source" : [ "obj-64", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-20", 0 ],
					"midpoints" : [ 73.5, 312.0, 21.0, 312.0, 21.0, 66.0, 73.5, 66.0 ],
					"source" : [ "obj-64", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-56", 0 ],
					"midpoints" : [ 117.0, 312.0, 51.0, 312.0, 51.0, 234.0, 73.5, 234.0 ],
					"source" : [ "obj-64", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 247.5, 327.0, 247.5, 327.0 ],
					"source" : [ "obj-64", 4 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 454.75, 48.0, 454.75, 48.0 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-122", 0 ],
					"midpoints" : [ 517.25, 330.0, 333.5, 330.0 ],
					"source" : [ "obj-71", 7 ]
				}
...
, 			{
				"name" : "SCP-serialharm.maxpat",
				"bootpath" : "~/Documents/GitHub/echolocate/max/ToyPiano01b/patchers",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
